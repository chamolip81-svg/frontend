    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-gray-900">
        ...
        <button
          ...
          className="absolute top-2 right-2 z-20 p-2 rounded-full bg-black/60 hover:bg-black/80 transition"
        >
          <Heart
            size={18}
        ...
        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition flex items-center justify-center">
          <button
            onClick={handlePlay}
            className="opacity-0 group-hover:opacity-100 transform scale-75 group-hover:scale-100 transition bg-green-500 rounded-full p-4"
          >
